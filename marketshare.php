...
$query = "SELECT COUNT(*) AS cantidad_lineas, MOD_USER, FECHA_ACTUALIZACION, NOM_ARCHIVO 
          FROM MKT_PREPAGO.DBO.TBL_MARKETSHARE_MKT
          WHERE DEPTO IS NOT NULL
          GROUP BY MOD_USER, FECHA_ACTUALIZACION, NOM_ARCHIVO
...
<head>
    ...
    <title>Métricas de Facebook</title>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form id="deleteForm" action="eliminar_marketshare.php" method="POST">
