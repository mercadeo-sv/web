...
$query = "SELECT NOM_ARCHIVO, COUNT(*) AS cantidad_lineas, MOD_USER AS USER_MOD, FECHA_ACTUALIZACION 
FROM MKT_PREPAGO.DBO.BENCH_PP_SV
WHERE NOM_ARCHIVO IS NOT NULL
GROUP BY NOM_ARCHIVO, MOD_USER, FECHA_ACTUALIZACION
...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Subir Archivo de Bench
                        </div>
                        <div class="card-body">
                            <form action="upload_bench.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Información de Cargas de Bench
                        </div>
                        <div class="card-body">
                            <?php if (empty($data)): ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form id="deleteForm" action="eliminar_bench.php" method="POST">
    ...
    <script>
        ...
        confirmDeleteModal.addEventListener('show.bs.modal', function (event) {
            ...
            var fechaCarga = button.getAttribute('data-fecha');
            var modalBodyInput = document.getElementById('fechaCarga');
